...
- [Demo](https://gist.github.com/dzy176/61331b3f80a6a185b2de45d27302f457)演示
...
- 实际应用
  ...
  sync.pool适用场景：在一些对象频繁创建，可以重复使用的场景，但是不适合保存那些有状态的对象，所以不怎么适合做连接池这样的东西
...
1. GMP模型
   - runtime_procPin()  runtime_procUnPin() 如何实现开放抢占与禁用抢占的
2. 原子操作原理(automic包)
   - 原子操作与锁操作的对比
3. go1.13版本之后对sync.pool优化的具体实现
4. 思考思考自己写过的golang项目是否有什么地方可以尝试使用sync.pool